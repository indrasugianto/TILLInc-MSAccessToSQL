/****** Object:  View [dbo].[vw_ExpirationsFormatted]    Script Date: 2/2/2026 11:17:10 AM ******/
SET ANSI_NULLS ON
GO
...
create   view [dbo].[vw_ExpirationsFormatted]
as
with TriggerValues as (
    ...
    select 
        ...
        -- Staff triggers (Section IS NULL, Program IS NULL)
        max(case when Section is null and Program is null and FieldName='BBP' then Red end) as Trig_Staff_BBP_Red,
        max(case when Section is null and Program is null and FieldName='BBP' then Green end) as Trig_Staff_BBP_Green,
        max(case when Section is null and Program is null and FieldName='BackInjuryPrevention' then Red end) as Trig_Staff_BIP_Red,
        max(case when Section is null and Program is null and FieldName='BackInjuryPrevention' then Green end) as Trig_Staff_BIP_Green,
        max(case when Section is null and Program is null and FieldName='CPR' then Red end) as Trig_Staff_CPR_Red,
        max(case when Section is null and Program is null and FieldName='CPR' then Green end) as Trig_Staff_CPR_Green,
        max(case when Section is null and Program is null and FieldName='DriversLicense' then Red end) as Trig_Staff_DL_Red,
        max(case when Section is null and Program is null and FieldName='DriversLicense' then Green end) as Trig_Staff_DL_Green,
        max(case when Section is null and Program is null and FieldName='FirstAid' then Red end) as Trig_Staff_FA_Red,
        max(case when Section is null and Program is null and FieldName='FirstAid' then Green end) as Trig_Staff_FA_Green,
        max(case when Section is null and Program is null and FieldName='SafetyCares' then Red end) as Trig_Staff_SC_Red,
        max(case when Section is null and Program is null and FieldName='SafetyCares' then Green end) as Trig_Staff_SC_Green,
        max(case when Section is null and Program is null and FieldName='TB' then Red end) as Trig_Staff_TB_Red,
        max(case when Section is null and Program is null and FieldName='TB' then Green end) as Trig_Staff_TB_Green,
        max(case when Section is null and Program is null and FieldName='WorkplaceViolence' then Red end) as Trig_Staff_WV_Red,
        max(case when Section is null and Program is null and FieldName='WorkplaceViolence' then Green end) as Trig_Staff_WV_Green,
        max(case when Section is null and Program is null and FieldName='ProfLic' then Red end) as Trig_Staff_PL_Red,
        max(case when Section is null and Program is null and FieldName='ProfLic' then Green end) as Trig_Staff_PL_Green,
        max(case when Section is null and Program is null and FieldName='MAPCert' then Red end) as Trig_Staff_MAP_Red,
        max(case when Section is null and Program is null and FieldName='MAPCert' then Green end) as Trig_Staff_MAP_Green,
        max(case when Section is null and Program is null and FieldName='EvalDueBy' then Red end) as Trig_Staff_EVL_Red,
        max(case when Section is null and Program is null and FieldName='EvalDueBy' then Green end) as Trig_Staff_EVL_Green,
        max(case when Section is null and Program is null and FieldName='LastSupervision' then Red end) as Trig_Staff_SUP_Red,
        max(case when Section is null and Program is null and FieldName='3MoEval' then Red end) as Trig_Staff_3MO_Red
...
select 
    ...
    case 
        when (e.DateISP = '1900-01-01' OR e.DateISP IS NULL) then 'RED'
    ...
    case 
        when (e.DateISP IN ('1900-01-01', '1900-01-02', '1900-01-03') OR e.DateISP IS NULL) then 0
        else 1
    end as DateISP_ShowDate,
    
    -- PSDue calculations (182 days before DateISP)
    case 
        when (e.DateISP IN ('1900-01-01', '1900-01-02', '1900-01-03') OR e.DateISP IS NULL) then null
        else dateadd(day, -182, e.DateISP)
    end as PSDue_Calculated,
    
    case 
        when (e.DateISP IN ('1900-01-01', '1900-01-02', '1900-01-03') OR e.DateISP IS NULL) then 'N/A'
        else convert(varchar(10), dateadd(day, -182, e.DateISP), 101)
    end as PSDue_Display,
    
    case 
        when (e.DateISP IN ('1900-01-01', '1900-01-02', '1900-01-03') OR e.DateISP IS NULL) then 'NORMAL'
    ...
    case 
        when (e.DateISP IN ('1900-01-01', '1900-01-02', '1900-01-03') OR e.DateISP IS NULL) then 1
        else 0
    ...
    case 
        when (e.DateConsentFormsSigned = '1900-01-01' OR e.DateConsentFormsSigned IS NULL) then 'RED'
    ...
    case 
        when (e.DateConsentFormsSigned IN ('1900-01-01', '1900-01-02', '1900-01-03') OR e.DateConsentFormsSigned IS NULL) then 0
        else 1
    ...
    case 
        when (e.DateBMMExpires = '1900-01-01' OR e.DateBMMExpires IS NULL) then 'RED'
    ...
    case 
        when (e.DateBMMExpires IN ('1900-01-01', '1900-01-02', '1900-01-03') OR e.DateBMMExpires IS NULL) then 0
        else 1
    ...
    case 
        when (e.DateSPDAuthExpires = '1900-01-01' OR e.DateSPDAuthExpires IS NULL) then 'RED'
    ...
    case 
        when (e.DateSPDAuthExpires IN ('1900-01-01', '1900-01-02', '1900-01-03') OR e.DateSPDAuthExpires IS NULL) then 0
        else 1
    ...
    case 
        when (e.DateSignaturesDueBy = '1900-01-01' OR e.DateSignaturesDueBy IS NULL) then 'RED'
    ...
    case 
        when (e.DateSignaturesDueBy IN ('1900-01-01', '1900-01-02', '1900-01-03') OR e.DateSignaturesDueBy IS NULL) then 0
        else 1
    ...
    case 
        when (e.LastVehicleChecklistCompleted IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.LastVehicleChecklistCompleted IS NULL) then 'NORMAL'
    ...
    case 
        when (e.LastVehicleChecklistCompleted IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.LastVehicleChecklistCompleted IS NULL) then 0
        else 1
    ...
    case 
        when (e.DAYStaffTrainedInPrivacyBefore IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.DAYStaffTrainedInPrivacyBefore IS NULL) then 'NORMAL'
    ...
    case 
        when (e.DAYStaffTrainedInPrivacyBefore IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.DAYStaffTrainedInPrivacyBefore IS NULL) then 0
        else 1
    ...
    case 
        when (e.DAYAllPlansReviewedByStaffBefore IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.DAYAllPlansReviewedByStaffBefore IS NULL) then 'NORMAL'
    ...
    case 
        when (e.DAYAllPlansReviewedByStaffBefore IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.DAYAllPlansReviewedByStaffBefore IS NULL) then 0
        else 1
    ...
    case 
        when (e.DAYQtrlySafetyChecklistDueBy IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.DAYQtrlySafetyChecklistDueBy IS NULL) then 'NORMAL'
    ...
    case 
        when (e.DAYQtrlySafetyChecklistDueBy IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.DAYQtrlySafetyChecklistDueBy IS NULL) then 0
        else 1
    ...
    case 
        when (e.MostRecentAsleepFireDrill IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.MostRecentAsleepFireDrill IS NULL) then 'NORMAL'
    ...
    case 
        when (e.MostRecentAsleepFireDrill IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.MostRecentAsleepFireDrill IS NULL) then 0
        else 1
    ...
    case 
        when (e.HousePlansReviewedByStaffBefore IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.HousePlansReviewedByStaffBefore IS NULL) then 'NORMAL'
    ...
    case 
        when (e.HousePlansReviewedByStaffBefore IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.HousePlansReviewedByStaffBefore IS NULL) then 0
        else 1
    ...
    case 
        when (e.HouseSafetyPlanExpires IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.HouseSafetyPlanExpires IS NULL) then 'NORMAL'
    ...
    case 
        when (e.HouseSafetyPlanExpires IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.HouseSafetyPlanExpires IS NULL) then 0
        else 1
    ...
    case 
        when (e.MAPChecklistCompleted IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.MAPChecklistCompleted IS NULL) then 'NORMAL'
    ...
    case 
        when (e.MAPChecklistCompleted IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.MAPChecklistCompleted IS NULL) then 0
        else 1
    ...
    case 
        when (e.HROTrainsStaffBefore IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.HROTrainsStaffBefore IS NULL) then 'NORMAL'
    ...
    case 
        when (e.HROTrainsStaffBefore IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.HROTrainsStaffBefore IS NULL) then 0
        else 1
    ...
    case 
        when (e.HROTrainsIndividualsBefore IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.HROTrainsIndividualsBefore IS NULL) then 'NORMAL'
    ...
    case 
        when (e.HROTrainsIndividualsBefore IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.HROTrainsIndividualsBefore IS NULL) then 0
        else 1
    ...
    case 
        when (e.FSOTrainsStaffBefore IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.FSOTrainsStaffBefore IS NULL) then 'NORMAL'
    ...
    case 
        when (e.FSOTrainsStaffBefore IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.FSOTrainsStaffBefore IS NULL) then 0
        else 1
    ...
    case 
        when (e.FSOTrainsIndividualsBefore IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.FSOTrainsIndividualsBefore IS NULL) then 'NORMAL'
    ...
    case 
        when (e.FSOTrainsIndividualsBefore IN ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') OR e.FSOTrainsIndividualsBefore IS NULL) then 0
        else 1
    ...
    -- ========================================
    -- BBP
    case when e.BBP = '1900-01-01' then 'Missing' when e.BBP = '1900-01-02' then 'Optional' when e.BBP = '1900-01-03' then 'N/A' when e.BBP = '1900-01-05' then 'Pending' when e.BBP is null then 'Missing' else convert(varchar(10), e.BBP, 101) end as BBP_Display,
    case when e.BBP in ('1900-01-01') or e.BBP is null then 'RED' when e.BBP in ('1900-01-02', '1900-01-03', '1900-01-05') then 'NORMAL' when datediff(day, cast(getdate() as date), e.BBP) < t.Trig_Staff_BBP_Red then 'RED' when t.Trig_Staff_BBP_Green is not null and datediff(day, cast(getdate() as date), e.BBP) <= t.Trig_Staff_BBP_Green then 'GREEN' else 'NORMAL' end as BBP_Color,
    case when e.BBP in ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') or e.BBP is null then 0 else 1 end as BBP_ShowDate,
    -- BackInjuryPrevention
    case when e.BackInjuryPrevention = '1900-01-01' then 'Missing' when e.BackInjuryPrevention = '1900-01-02' then 'Optional' when e.BackInjuryPrevention = '1900-01-03' then 'N/A' when e.BackInjuryPrevention = '1900-01-05' then 'Pending' when e.BackInjuryPrevention is null then 'Missing' else convert(varchar(10), e.BackInjuryPrevention, 101) end as BackInjuryPrevention_Display,
    case when e.BackInjuryPrevention in ('1900-01-01') or e.BackInjuryPrevention is null then 'RED' when e.BackInjuryPrevention in ('1900-01-02', '1900-01-03', '1900-01-05') then 'NORMAL' when datediff(day, cast(getdate() as date), e.BackInjuryPrevention) < t.Trig_Staff_BIP_Red then 'RED' when t.Trig_Staff_BIP_Green is not null and datediff(day, cast(getdate() as date), e.BackInjuryPrevention) <= t.Trig_Staff_BIP_Green then 'GREEN' else 'NORMAL' end as BackInjuryPrevention_Color,
    case when e.BackInjuryPrevention in ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') or e.BackInjuryPrevention is null then 0 else 1 end as BackInjuryPrevention_ShowDate,
    -- CPR
    case when e.CPR = '1900-01-01' then 'Missing' when e.CPR = '1900-01-02' then 'Optional' when e.CPR = '1900-01-03' then 'N/A' when e.CPR = '1900-01-05' then 'Pending' when e.CPR is null then 'Missing' else convert(varchar(10), e.CPR, 101) end as CPR_Display,
    case when e.CPR in ('1900-01-01') or e.CPR is null then 'RED' when e.CPR in ('1900-01-02', '1900-01-03', '1900-01-05') then 'NORMAL' when datediff(day, cast(getdate() as date), e.CPR) < t.Trig_Staff_CPR_Red then 'RED' when t.Trig_Staff_CPR_Green is not null and datediff(day, cast(getdate() as date), e.CPR) <= t.Trig_Staff_CPR_Green then 'GREEN' else 'NORMAL' end as CPR_Color,
    case when e.CPR in ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') or e.CPR is null then 0 else 1 end as CPR_ShowDate,
    -- DefensiveDriving (no Red/Green in triggers; show date or "Done"/text)
    case when e.DefensiveDriving = '1900-01-01' then 'Missing' when e.DefensiveDriving = '1900-01-02' then 'Optional' when e.DefensiveDriving = '1900-01-03' then 'N/A' when e.DefensiveDriving = '1900-01-04' then 'Done' when e.DefensiveDriving = '1900-01-05' then 'Pending' when e.DefensiveDriving is null then 'Missing' else convert(varchar(10), e.DefensiveDriving, 101) end as DefensiveDriving_Display,
    'NORMAL' as DefensiveDriving_Color,
    case when e.DefensiveDriving in ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') or e.DefensiveDriving is null then 0 else 1 end as DefensiveDriving_ShowDate,
    -- DriversLicense
    case when e.DriversLicense = '1900-01-01' then 'Missing' when e.DriversLicense = '1900-01-02' then 'Optional' when e.DriversLicense = '1900-01-03' then 'N/A' when e.DriversLicense = '1900-01-05' then 'Pending' when e.DriversLicense is null then 'Missing' else convert(varchar(10), e.DriversLicense, 101) end as DriversLicense_Display,
    case when e.DriversLicense in ('1900-01-01') or e.DriversLicense is null then 'RED' when e.DriversLicense in ('1900-01-02', '1900-01-03', '1900-01-05') then 'NORMAL' when datediff(day, cast(getdate() as date), e.DriversLicense) < t.Trig_Staff_DL_Red then 'RED' when t.Trig_Staff_DL_Green is not null and datediff(day, cast(getdate() as date), e.DriversLicense) <= t.Trig_Staff_DL_Green then 'GREEN' else 'NORMAL' end as DriversLicense_Color,
    case when e.DriversLicense in ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') or e.DriversLicense is null then 0 else 1 end as DriversLicense_ShowDate,
    -- FirstAid
    case when e.FirstAid = '1900-01-01' then 'Missing' when e.FirstAid = '1900-01-02' then 'Optional' when e.FirstAid = '1900-01-03' then 'N/A' when e.FirstAid = '1900-01-05' then 'Pending' when e.FirstAid is null then 'Missing' else convert(varchar(10), e.FirstAid, 101) end as FirstAid_Display,
    case when e.FirstAid in ('1900-01-01') or e.FirstAid is null then 'RED' when e.FirstAid in ('1900-01-02', '1900-01-03', '1900-01-05') then 'NORMAL' when datediff(day, cast(getdate() as date), e.FirstAid) < t.Trig_Staff_FA_Red then 'RED' when t.Trig_Staff_FA_Green is not null and datediff(day, cast(getdate() as date), e.FirstAid) <= t.Trig_Staff_FA_Green then 'GREEN' else 'NORMAL' end as FirstAid_Color,
    case when e.FirstAid in ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') or e.FirstAid is null then 0 else 1 end as FirstAid_ShowDate,
    -- PBS
    case when e.PBS = '1900-01-01' then 'Missing' when e.PBS = '1900-01-02' then 'Optional' when e.PBS = '1900-01-03' then 'N/A' when e.PBS = '1900-01-04' then 'Done' when e.PBS = '1900-01-05' then 'Pending' when e.PBS is null then 'Missing' else convert(varchar(10), e.PBS, 101) end as PBS_Display,
    'NORMAL' as PBS_Color,
    case when e.PBS in ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') or e.PBS is null then 0 else 1 end as PBS_ShowDate,
    -- SafetyCares
    case when e.SafetyCares = '1900-01-01' then 'Missing' when e.SafetyCares = '1900-01-02' then 'Optional' when e.SafetyCares = '1900-01-03' then 'N/A' when e.SafetyCares = '1900-01-05' then 'Pending' when e.SafetyCares is null then 'Missing' else convert(varchar(10), e.SafetyCares, 101) end as SafetyCares_Display,
    case when e.SafetyCares in ('1900-01-01') or e.SafetyCares is null then 'RED' when e.SafetyCares in ('1900-01-02', '1900-01-03', '1900-01-05') then 'NORMAL' when datediff(day, cast(getdate() as date), e.SafetyCares) < t.Trig_Staff_SC_Red then 'RED' when t.Trig_Staff_SC_Green is not null and datediff(day, cast(getdate() as date), e.SafetyCares) <= t.Trig_Staff_SC_Green then 'GREEN' else 'NORMAL' end as SafetyCares_Color,
    case when e.SafetyCares in ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') or e.SafetyCares is null then 0 else 1 end as SafetyCares_ShowDate,
    -- TB
    case when e.TB = '1900-01-01' then 'Missing' when e.TB = '1900-01-02' then 'Optional' when e.TB = '1900-01-03' then 'N/A' when e.TB = '1900-01-04' then 'Completed' when e.TB = '1900-01-05' then 'Pending' when e.TB is null then 'Missing' else convert(varchar(10), e.TB, 101) end as TB_Display,
    case when e.TB in ('1900-01-01') or e.TB is null then 'RED' when e.TB in ('1900-01-02', '1900-01-03', '1900-01-04', '1900-01-05') then 'NORMAL' when datediff(day, cast(getdate() as date), e.TB) < t.Trig_Staff_TB_Red then 'RED' when t.Trig_Staff_TB_Green is not null and datediff(day, cast(getdate() as date), e.TB) <= t.Trig_Staff_TB_Green then 'GREEN' else 'NORMAL' end as TB_Color,
    case when e.TB in ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-04', '1900-01-05') or e.TB is null then 0 else 1 end as TB_ShowDate,
    -- WheelchairSafety
    case when e.WheelchairSafety = '1900-01-01' then 'Missing' when e.WheelchairSafety = '1900-01-02' then 'Optional' when e.WheelchairSafety = '1900-01-03' then 'N/A' when e.WheelchairSafety = '1900-01-04' then 'Done' when e.WheelchairSafety = '1900-01-05' then 'Pending' when e.WheelchairSafety is null then 'Missing' else convert(varchar(10), e.WheelchairSafety, 101) end as WheelchairSafety_Display,
    'NORMAL' as WheelchairSafety_Color,
    case when e.WheelchairSafety in ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') or e.WheelchairSafety is null then 0 else 1 end as WheelchairSafety_ShowDate,
    -- WorkplaceViolence
    case when e.WorkplaceViolence = '1900-01-01' then 'Missing' when e.WorkplaceViolence = '1900-01-02' then 'Optional' when e.WorkplaceViolence = '1900-01-03' then 'N/A' when e.WorkplaceViolence = '1900-01-05' then 'Pending' when e.WorkplaceViolence is null then 'Missing' else convert(varchar(10), e.WorkplaceViolence, 101) end as WorkplaceViolence_Display,
    case when e.WorkplaceViolence in ('1900-01-01') or e.WorkplaceViolence is null then 'RED' when e.WorkplaceViolence in ('1900-01-02', '1900-01-03', '1900-01-05') then 'NORMAL' when datediff(day, cast(getdate() as date), e.WorkplaceViolence) < t.Trig_Staff_WV_Red then 'RED' when t.Trig_Staff_WV_Green is not null and datediff(day, cast(getdate() as date), e.WorkplaceViolence) <= t.Trig_Staff_WV_Green then 'GREEN' else 'NORMAL' end as WorkplaceViolence_Color,
    case when e.WorkplaceViolence in ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') or e.WorkplaceViolence is null then 0 else 1 end as WorkplaceViolence_ShowDate,
    -- ProfessionalLicenses (trigger table uses ProfLic)
    case when e.ProfessionalLicenses = '1900-01-01' then 'Missing' when e.ProfessionalLicenses = '1900-01-02' then 'Optional' when e.ProfessionalLicenses = '1900-01-03' then 'N/A' when e.ProfessionalLicenses = '1900-01-05' then 'Pending' when e.ProfessionalLicenses is null then 'Missing' else convert(varchar(10), e.ProfessionalLicenses, 101) end as ProfessionalLicenses_Display,
    case when e.ProfessionalLicenses in ('1900-01-01') or e.ProfessionalLicenses is null then 'RED' when e.ProfessionalLicenses in ('1900-01-02', '1900-01-03', '1900-01-05') then 'NORMAL' when datediff(day, cast(getdate() as date), e.ProfessionalLicenses) < t.Trig_Staff_PL_Red then 'RED' when t.Trig_Staff_PL_Green is not null and datediff(day, cast(getdate() as date), e.ProfessionalLicenses) <= t.Trig_Staff_PL_Green then 'GREEN' else 'NORMAL' end as ProfessionalLicenses_Color,
    case when e.ProfessionalLicenses in ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') or e.ProfessionalLicenses is null then 0 else 1 end as ProfessionalLicenses_ShowDate,
    -- MAPCert
    case when e.MAPCert = '1900-01-01' then 'Missing' when e.MAPCert = '1900-01-02' then 'Optional' when e.MAPCert = '1900-01-03' then 'N/A' when e.MAPCert = '1900-01-05' then 'Pending' when e.MAPCert is null then 'Missing' else convert(varchar(10), e.MAPCert, 101) end as MAPCert_Display,
    case when e.MAPCert in ('1900-01-01') or e.MAPCert is null then 'RED' when e.MAPCert in ('1900-01-02', '1900-01-03', '1900-01-05') then 'NORMAL' when datediff(day, cast(getdate() as date), e.MAPCert) < t.Trig_Staff_MAP_Red then 'RED' when t.Trig_Staff_MAP_Green is not null and datediff(day, cast(getdate() as date), e.MAPCert) <= t.Trig_Staff_MAP_Green then 'GREEN' else 'NORMAL' end as MAPCert_Color,
    case when e.MAPCert in ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') or e.MAPCert is null then 0 else 1 end as MAPCert_ShowDate,
    -- EvalDueBy
    case when e.EvalDueBy = '1900-01-01' then 'Missing' when e.EvalDueBy = '1900-01-02' then 'Optional' when e.EvalDueBy = '1900-01-03' then 'N/A' when e.EvalDueBy = '1900-01-05' then 'Pending' when e.EvalDueBy is null then 'Missing' else convert(varchar(10), e.EvalDueBy, 101) end as EvalDueBy_Display,
    case when e.EvalDueBy in ('1900-01-01') or e.EvalDueBy is null then 'RED' when e.EvalDueBy in ('1900-01-02', '1900-01-03', '1900-01-05') then 'NORMAL' when datediff(day, cast(getdate() as date), e.EvalDueBy) < t.Trig_Staff_EVL_Red then 'RED' when t.Trig_Staff_EVL_Green is not null and datediff(day, cast(getdate() as date), e.EvalDueBy) <= t.Trig_Staff_EVL_Green then 'GREEN' else 'NORMAL' end as EvalDueBy_Color,
    case when e.EvalDueBy in ('1900-01-01', '1900-01-02', '1900-01-03', '1900-01-05') or e.EvalDueBy is null then 0 else 1 end as EvalDueBy_ShowDate,
    -- LastSupervision
    case when e.LastSupervision = '1900-01-01' then 'Missing' when e.LastSupervision = '1900-01-02' then 'Optional' when e.LastSupervision = '1900-01-03' then 'N/A' when e.LastSupervision is null then 'Missing' else convert(varchar(10), e.LastSupervision, 101) end as LastSupervision_Display,
    case when e.LastSupervision is null then 'NORMAL' when datediff(day, e.LastSupervision, cast(getdate() as date)) > t.Trig_Staff_SUP_Red then 'RED' else 'NORMAL' end as LastSupervision_Color,
    case when e.LastSupervision in ('1900-01-01', '1900-01-02', '1900-01-03') or e.LastSupervision is null then 0 else 1 end as LastSupervision_ShowDate
