' Module Name: Report_ltrINDIVFINANCESold
...
On Error GoTo ShowMeError
    Dim CountOfFamily As Variant, TILLRepPayeeCheck As Variant
    ...
    If IsNull(WorkingABI) Or IsEmpty(WorkingABI) Then
        Label124.Visible = False: RemainingBenefits.Visible = False
    ...
    ElseIf WorkingABI Then
        Label124.Visible = True: RemainingBenefits.Visible = True
